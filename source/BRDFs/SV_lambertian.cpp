...
{
	SV_LambertianBRDF::SV_LambertianBRDF(
		const float kd, std::shared_ptr<poly::texture::Texture> tex)
	{
		m_kd = kd;
		m_cd = tex;
	}

	Colour SV_LambertianBRDF::f(

...
namespace poly::light {
        ...
        math::Vector AmbientOcclusion::direction_get([[maybe_unused]] poly::structures::ShadeRec& sr)
        {
          return math::Vector(0.0f, 0.0f, 0.0f);
        }

        // Specific to ambient occlusion, we need access to samples mapped to hemisphere
        math::Vector AmbientOcclusion::shadow_direction_get([[maybe_unused]] poly::structures::ShadeRec& sr, unsigned int sample_index)
        {
        ...
        Colour AmbientOcclusion::L(poly::structures::ShadeRec& sr)
        {
